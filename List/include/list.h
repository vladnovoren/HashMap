...
int         List_PushFront(List* list, const ListElemT new_elem,
                                       size_t* phys_id = NULL);

int         List_PushBack(List* list, const ListElemT new_elem,
                                      size_t* phys_id = NULL);
...
int         List_InsertAfter(List* list, const size_t phys_id,
                                         const ListElemT new_elem);
